...
## ECCV
* `ECCV2020` Learning Joint Spatial-Temporal Transformations for Video Inpainting [[code]](https://github.com/researchmm/STTN)
* `ECCV2020` Proposal based Video Completion [[link]]()[[code]]()
* `ECCV2020` Flow-edge Guided Video Completion [[link]]()[[code]]()
* `ECCV2020` Rethinking image inpainting via a mutual encoder-decoder with feature equalization [[link]]()[[code]]()
* `ECCV2020` DVI: Depth Guided Video Inpainting for Autonomous Driving [[link]]()[[code]]()
* `ECCV2020` Deep Space-Time Video Upsampling Networks [[link]](https://www.youtube.com/watch?v=ZQoGbN16zKk)[[code]](https://github.com/JaeYeonKang/STVUN-Pytorch)
* `ECCV2020` Defocus Blur Detection via Depth Distillation [[code]](https://github.com/vinthony/depth-distillation)
* `ECCV2020` From Shadow Segmentation to Shadow Removal [[link]]()[[code]]()
* `ECCV2020` Filter Style Transfer between Photos [[link]]()[[code]]()
* `ECCV2020` Invertible Image Rescaling [[code]](https://github.com/pkuxmq/Invertible-Image-Rescaling)
* `ECCV2020` Rewriting a Deep Generative Model [[link]](https://rewriting.csail.mit.edu/)[[code]](https://github.com/davidbau/rewriting)
* `ECCV2020` MatryODShka: Real-time 6DoF Video View Synthesis using Multi-Sphere Images [[link]](http://visual.cs.brown.edu/projects/matryodshkawebpage/)
* `ECCV2020` Unsupervised Sketch-to-Photo Synthesis [[link]]()[[code]]()
* `ECCV2020` DTVNet: Dynamic Time-lapse Video Generation via Single Still Image [[code]](https://github.com/zhangzjn/DTVNet)
* `ECCV2020` BMBC:Bilateral Motion Estimation with Bilateral Cost Volume for Video Interpolation [[link]](https://mcl.korea.ac.kr/research/jhpark-eccv2020/index.html)[[code]](https://github.com/JunHeum/BMBC)
* `ECCV2020` Colorization of Depth Map via Disentanglement [[link]]()[[code]]()
* `ECCV2020` Controllable Image Synthesis via SegVAE [[link]](https://yccyenchicheng.github.io/SegVAE/)[[code]](https://github.com/yccyenchicheng/SegVAE)
* `ECCV2020` CooGAN: A Memory-Efficient Framework for High-Resolution Facial Attribute Editing [[link]]()[[code]]()
* `ECCV2020` DeepLandscape: Adversarial Modeling of Landscape Video [[code]](https://github.com/saic-mdal/deep-landscape)
* `ECCV2020` High-Resolution Image Inpainting with Iterative Confidence Feedback and Guided Upsampling [[link]](https://zengxianyu.github.io/iic/)[[code]]()
* `ECCV2020` In-Domain GAN Inversion for Real Image Editing [[link]](https://genforce.github.io/idinvert/)[[code]](https://github.com/genforce/idinvert_pytorch)
* `ECCV2020` Lifespan Age Transformation Synthesis [[link]](https://grail.cs.washington.edu/projects/lifespan_age_transformation_synthesis/)[[code]](https://github.com/royorel/Lifespan_Age_Transformation_Synthesis)
* `ECCV2020` Neural Hair Rendering [[link]]()[[code]]()
* `ECCV2020` Neural Re-Rendering of Humans from a Single Image [[link]](http://gvv.mpi-inf.mpg.de/projects/NHRR/)
* `ECCV2020` Novel View Synthesis on Unpaired Data by Conditional Deformable Variational Auto-Encoder [[link]]()[[code]]()
* `ECCV2020` StyleGAN2 Distillation for Feed-forward Image Manipulation [[code]](https://github.com/EvgenyKashin/stylegan2-distillation)
* `ECCV2020` Talking-head Generation with Rhythmic Head Motion [[code]](https://github.com/lelechen63/Talking-head-Generation-with-Rhythmic-Head-Motion)
* `ECCV2020` Unpaired Image-to-Image Translation using Adversarial Consistency Loss [[link]]()[[code]]()
* `ECCV2020` Unselfie: Translating Selfies to Neutral-pose Portraits in the Wild [[link]](http://charliememory.github.io/ECCV20_Unselfie/)[[code]]()
* `ECCV2020` World-Consistent Video-to-Video Synthesis [[link]](https://nvlabs.github.io/wc-vid2vid/)[[code]](https://github.com/NVlabs/imaginaire)
* `ECCV2020` Learning Stereo from Single Images [[code]](https://github.com/nianticlabs/stereo-from-mono)
* `ECCV2020` Occlusion-Aware Depth Estimation with Adaptive Normal Constraints [[link]]()[[code]]()
* `ECCV2020` Synthesis and Completion of Facades from Satellite Imagery [[link]]()[[code]]()
* `ECCV2020` Learning to Factorize a City [[link]](https://factorize-a-city.github.io/)[[code]]()
* `ECCV2020` BézierSketch: A generative model for scalable vector sketches [[link]]()[[code]]()
* `ECCV2020` AutoSimulate: (Quickly) Learning Synthetic Data Generation [[link]](http://www.vibhavvineet.info/papers/2020/eccv20/main_eccv20.pdf)
* `ECCV2020` Contrastive Learning for Conditional Image Generation [[link]](https://taesung.me/ContrastiveUnpairedTranslation/)[[code]](https://github.com/taesungp/contrastive-unpaired-translation)
* `ECCV2020` Curriculum DeepSDF [[code]](https://github.com/haidongz-usc/Curriculum-DeepSDF)
* `ECCV2020` Deep Multi Depth Panoramas for View Synthesis [[link]](http://cseweb.ucsd.edu/~ravir/kaien_eccv20.pdf)[[code]]()
* `ECCV2020` Deformable Style Transfer [[link]](https://sunniesuhyoung.github.io/DST-page/)
* `ECCV2020` Hierarchical Style-based Networks for Motion Synthesis [[link]](https://sites.google.com/view/hsnms/home)[[code]]()
* `ECCV2020` High Resolution Zero-Shot Domain Adaptation of Synthetically Rendered Face Images [[link]]()[[code]]()
* `ECCV2020` SG-VAE: Scene Grammar Variational Autoencoder to generate new indoor scenes [[link]]()[[code]]()
* `ECCV2020` Self-supervised Outdoor Scene Relighting [[link]]()[[code]]()
* `ECCV2020` Who left the dogs out? 3D Animal Reconstruction with Expectation Maximization in the Loop [[link]](https://sites.google.com/view/wldo)[[code]]()
